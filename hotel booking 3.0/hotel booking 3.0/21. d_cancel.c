...
// DELUXE ROOM CANCELLATION FUNCTION
void d_cancel()
{
	FILE* fp, * tp, *cp;
	int i = 1, menu;
	char rNumber[4];
	char ch[1000];
	if ((cp = fopen("d_cancellation.txt", "a+")) == NULL)
		if ((cp = fopen("d_cancellation.txt", "w+")) == NULL)
			exit(0);
	...
	printf("                             ************************************************************\n");
	printf("                              *****                                                *****\n");
	printf("                               ****              DELUXE ROOM CANCELLATION          ****\n");
	printf("                              *****                                                *****\n");
	printf("                             ************************************************************\n\n\n");
	...
	else
	{
		...
		fclose(tp);
		fclose(cp);
		remove("deluxe_room_booking.txt");
		rename("temp.txt", "deluxe_room_booking.txt");
