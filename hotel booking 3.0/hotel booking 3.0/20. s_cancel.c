...
// STANDARD ROOM CANCELLATION FUNCTION
void s_cancel()
{
	FILE* fp, * tp, * cp;
	int i = 1, menu;
	char rNumber[4];
	char ch[1000];
	if ((cp = fopen("s_cancellation.txt", "a+")) == NULL)
		if ((cp = fopen("s_cancellation.txt", "w+")) == NULL)
			exit(0);
	...
	printf("                             ************************************************************\n");
	printf("                              *****                                                *****\n");
	printf("                               ****             STANDARD ROOM CANCELLATION         ****\n");
	printf("                              *****                                                *****\n");
	printf("                             ************************************************************\n\n\n");
	...
	else
	{
		...
		fclose(tp);
		fclose(cp);
		remove("standard_room_booking.txt");
		rename("temp.txt", "standard_room_booking.txt");
